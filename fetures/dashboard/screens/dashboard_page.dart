...
import 'package:hostel_management_app/fetures/dashboard/widgets/going_to_vacant_card.dart';
...
class _DashBoardPageState extends State<DashBoardPage>
  ...
  Future<void> _initializeData() async {
    ...
    await Provider.of<BookingsController>(context, listen: false).fetchBookingsData();
        ...
        title: Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Text(
                controller.user?.ownerName ?? "Loading...",
          ...
          InkWell(
            ...
            child: Hero(
              ...
              child: Container(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(100),
                  child: controller.user?.profilePicture?.isNotEmpty == true
                      ? CachedNetworkImage(
                  ...
                  children: [
                    Consumer<UserController>(
                      builder: (context, value, child) => SlideTransition(
                        ...
                        child: RoomVacantCard(
                          title: "Beds Vacant",
                          number: value.user?.noOfVacancy?.toString() ?? "0",
                ...
                builder: (context, value, child) {
                  if (value.roomsGoingtoVacant.isNotEmpty) {
                    return Padding(
                      ...
                      child: GridView.builder(
                        ...
                        itemBuilder: (context, index) => SlideTransition(
                          ...
                          child: GoingToVacantCard(
                              roomNumber: value.roomsGoingtoVacant[index]
                                      ["RoomNo"]
                                  .toString(),
                              bedNumber: value.roomsGoingtoVacant[index]
                                      ["Vacancy"]
                                  .toString(),
                    ...
                    return SizedBox(
                      ...
                      child: Center(
                        child: Text(
                            "No Rooms going to Vacant ${value.selectedValue}"),
                      ),
                    );
                  }
                },
