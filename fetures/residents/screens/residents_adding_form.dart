          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: InkWell(
                  onTap: () async {
                    print("Add/Edit button pressed");
                    if (controller.formKey.currentState!.validate()) {
                      print("Form validation passed");
                      try {
                        if (controller.isEditing) {
                          print("Editing resident...");
                          await controller.editResident(context);
                        } else {
                          print("Adding new resident...");
                          ...
                          if (controller.selectedRoom == null || controller.selectedRoom == "0") {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text("Please select a room")),
                            );
                            return;
                          }
                          await controller.addResident(context);
                        }
                      } catch (e) {
                        print("Error in add/edit resident: $e");
                        ScaffoldMessenger.of(context).showSnackBar(
