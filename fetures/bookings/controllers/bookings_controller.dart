...
//----------------------------------------------------------------------------- fetching vacant rooms
  ...
  addBooking({
    ...
    try {
      // Prevent booking if joining date is not selected
      if (dateController.text.isEmpty || checkInDate == null) {
      ...
      final RoomModel? room = await roomController.fetchSingleRoom(roomId: roomId);
