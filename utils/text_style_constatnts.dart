...
class TextStyleConstants {
  ...
  static TextStyle dashboardVacantRoom1 = TextStyle(
    fontSize: 16,
    fontWeight: FontWeight.w500,
    color: ColorConstants.primaryBlackColor,
  );

  static TextStyle dashboardVacantRoom2 = TextStyle(
    fontSize: 14,
    fontWeight: FontWeight.w400,
    color: ColorConstants.primaryBlackColor,
  );
  ...
  static TextStyle upComingVacancyText1 = TextStyle(
    fontSize: 16,
    fontWeight: FontWeight.w500,
    color: ColorConstants.primaryBlackColor,
  );

  static TextStyle upComingVacancyText2 = TextStyle(
    fontSize: 14,
    fontWeight: FontWeight.w400,
    color: ColorConstants.primaryBlackColor,
  );
